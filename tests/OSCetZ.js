...
On étaint la carte est met les interrupteurs sur le config que l'on veut
...
sock = dgram.createSocket("udp4", function(msg, rinfo) {
   ...
   if (debug) {
    ...
    switch(message.address) {
      ...
      case "/OSCNOTEON":
        ...
        sock.send(buf, 0, buf.length, 1000, "192.168.1.70");
        break;
 ...
 // 3005 pour data et 3006 pour MIDI
 sock.bind(3005, "192.168.1.75");
...
function sendHeartbeat() {
  ...
  flag = !flag;
  return sock.send(buf, 0, buf.length, 1000, "192.168.1.70");
}
