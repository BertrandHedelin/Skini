...
*/
  ...
  // Pour tank:  nom du groupe(0), index(1), type(2), x(3), y(4), numéro du tank(5), color(6), prédécesseurs(7), n° de scène graphique

[  // Opus 1
  ["violonsEchelle", 0,  "group",  90,  30, 9, [203,120,132], [5], 1],  //0
  ["violonsChrom",1, "group",  800,  180, 16, [203,120,132], [9], 2],  //1
  ["violonsTonal",2,  "group",  450,  25, 24, [203,120,132], [30], 3],  //2
  ["altosEchelle", 3,  "group",  90,  90, 6, [203,120,132], [5], 1],    //3
  ["altosChrom", 4,  "group",  800,  270, 16, [203,120,132], [9], 2], //4
  ["cellosEchelle", 5,  "group",  10,  240, 6, [203,120,132], [28], 1], //5
  ["cellosChrom", 6, "group",  800,  360, 16, [203,120,132], [9],2],  //6
  ["cellosTonal", 7,  "group",  650,  100, 8, [203,120,132], [2], 3],   //7
  ["ctrebassesEchelle", 8,  "group",  90,  150, 6, [203,120,132], [5], 1], //8
  ["ctrebassesChrom", 9,  "group",  590,  430, 16, [203,120,132], [25, 29], 2], //9
  ["ctrebassesTonal", 10,  "group",  650,  160, 6, [203,120,132], [2], 3],  //10
  ["trompettesEchelle1", 11, "tank",  90,  300, 1, [203,120,132], [5], 1], //11
  ...
  ["trompettesTonal1", 15,  "tank",  650,  280, 2, [203,120,132], [2], 3], //12
  ["trompettesTonal2", 16,  "tank",  200,  100, 2, [203,120,132], []],
  ["trompettesTonal3", 17, "tank",  200,  100, 2, [203,120,132], []],
  ["corsEchelle1", 18, "tank",  90,  400, 3, [203,120,132], [5], 1], //13
  ...
  ["trombonesEchelle1", 25,  "tank",  90,  550, 4, [203,120,132], [5], 1],  //14
  ...
  ["flutesEchelle1", 32,  "tank",  280,  300, 5, [203,120,132], [11,13,14], 1],  //15
  ...
  ["flutesChrom", 37,  "group",  800,  450, 16, [203,120,132], [9], 2],  //16
  ["flutesTonal", 38,  "group",  800,  30, 24, [203,120,132], [2], 3],  //17
  ["hautboisEchelle1", 39,  "tank",  280,  400, 6, [203,120,132], [11,13,14], 1],  //18
  ...
  ["hautboisTonal", 44,  "group",  650,  220, 8, [203,120,132], [2], 3],  //19
  ["clarinettesEchelle1", 45,  "tank",  280,  550, 7, [203,120,132], [11,13,14], 1],    //20
  ...
  ["clarinettesChrom", 50, "group",  800,  630, 16, [203,120,132], [9], 2], //21
  ["bassonsEchelle", 51, "group",  90,  230, 5, [203,120,132], [5], 1],   //22
  ["bassonsChrom", 52, "group",  800,  540, 16, [203,120,132], [9], 2],  //23
  ["pianoEchelle1", 53,   "tank",  400,  250, 8, [203,120,132], [15,18,20], 1], //24
  ...
  ["percu1", 59,   "tank",  420,  410, 9, [203,120,132], [], 4], //25
  ...
  ["kinetic1", 68,   "tank",  650,  340, 10, [203,120,132], [2], 3], //26
  ["kinetic2", 69,   "tank",  650,  500, 10, [203,120,132], []],  
  ["kinetic3", 70,   "tank",  300,  500, 10, [203,120,132], []],
  ["rise1", 71,   "tank",  500,  350, 11, [203,120,132], [], 4], //27
  ["rise2", 72,   "tank",  300,  700, 11, [203,120,132], []],
  // Exemple de choix. Pour ne pas afficher un choix, il suffit de le mettre dans
  // une scene inactive
  ["Messiaen", 73, "group",  10,  100, 0, [203,120,132], [], 10], // 28
  ["Shostakovich", 74, "group",  520,  600, 0, [203,120,132], [], 10], // 29
  ["Britten", 75, "group",  350,  25, 0, [203,120,132], [], 10] //30
],
...
[  // Techno
  ...
  ["evolve",  0, "tank", 100, 100, 1, [103,120,132], [] ],          // 0
  ["poly", 1, "tank",130, 100, 1, [213,120,132], [] ],        // 0
  ["fm", 2, "group", 270, 100, 20, [203,120,132], [] ],    // 1
  ["massive",3, "group",400,100,  20, [89,99,77], []  ],         // 2
  ["round", 4,"group", 530, 100, 20, [78,67,67], [] ],           // 3
  ["absynth", 5, "group", 666,100, 20, [87,98,132], [] ],           // 4
  ["drone", 6, "group", 530, 240, 20, [56,120,132], [] ],     // 5
  ["alien", 7, "group", 270, 240, 20, [203,100,102], [] ],    // 6
  ["notes", 8, "group", 400, 240, 20, [100,100,100], [] ] // 7
],

[  // Nucera
  ["PolyUsine", 0, "group", 15, 100, 17, [103,120,132], []  ],
  ["FM8Usine", 1, "group", 130, 100, 17, [103,120,132], [0] ],
  ["MassiveUsine", 2, "group", 270, 100, 17, [103,120,132], [1] ],
  ["PrismUsine", 3, "group", 400, 100, 17, [103,120,132], [2] ],
  ["LPSUsine", 4, "group", 540, 100, 17, [103,120,132], [3] ],
  ["AbsynthUsine", 5, "group", 666, 100, 17, [103,120,132], [4] ],
  ["LoopUsine", 6, "group", 793, 100, 17, [103,120,132], [5] ],

  ["PolyConscience", 7, "group", 15, 240, 17, [103,120,132], [] ],
  ["FM8Conscience", 8, "group", 130, 240, 17, [103,120,132], [7] ],
  ["MassiveConscience", 9, "group", 270, 240, 17, [103,120,132], [8] ],
  ["PrismConscience", 10, "group", 400, 240, 17, [103,120,132], [9] ],
  ["AbsynthConscience", 11, "group", 540, 240, 17, [103,120,132], [10] ],

  ["PolyMaladie", 12, "group", 15, 370, 17, [103,120,132], [] ],
  ["FM8Maladie", 13, "group", 130, 370, 17, [103,120,132], [12] ],
  ["MassiveMaladie", 14, "group", 270, 370, 17, [103,120,132], [13] ],
  ["PrismMaladie", 15, "group", 400, 370, 17, [103,120,132], [14] ],
  ["GiantMaladie", 16, "group", 540, 370, 17, [103,120,132], [15] ],
  ["AbsynthMaladie", 17, "group", 666, 370, 17, [103,120,132], [16] ],

  ["MassiveArret", 18, "group", 15, 510, 17, [103,120,132], [] ],
  ["LPSArret", 19, "group", 130, 510, 17, [103,120,132], [18] ],
  ["AbsynthArret", 20, "group", 270, 510, 17, [103,120,132], [19] ],

  ["PolyGuerison", 21, "group", 15, 630, 17, [103,120,132], [] ],
  ["FM8Guerison", 22, "group", 130, 630, 17, [103,120,132], [21] ],  
  ["MassiveGuerison", 23, "group", 250, 630, 17, [103,120,132], [22] ],
  ["PrismGuerison", 24, "group", 380, 630, 17, [103,120,132], [23] ],
  ["LPSGuerison", 25, "group", 500, 630, 17, [103,120,132], [24] ],
  ["GiantGuerison", 26, "group", 620, 630, 17, [103,120,132], [25] ],
  ["AbsynthGuerison", 27, "group", 740, 630, 17, [103,120,132], [26] ],
  ["LoopGuerison", 28, "group", 873, 630, 17, [103,120,132], [27] ]
]
