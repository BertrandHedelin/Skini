...
Peut être utilisé avec Reaper sur la partie séquenceur distribué en changeant
les note midi affecté au instrument.
...
[  // Opus 1
  ...
  ["corsEchelle1", 18, "tank",  350,  527, 3, [203,120,132], [11], 1], //13
  ...
  ["trombonesEchelle1", 25,  "tank",  500,  528, 4, [203,120,132], [13], 1],  //14
  ...
  ["flutesEchelle1", 32,  "tank",  627,  113, 5, [203,120,132], [22,24,14], 1],  //15
  ...
  ["hautboisEchelle1", 39,  "tank",  789, 130, 6, [203,120,132], [15], 1],  //18
  ...
  ["clarinettesEchelle1", 45,  "tank",  768,  376, 7, [203,120,132], [15], 1],    //20
  ...
  ["bassonsEchelle", 51, "group",  464,  143, 10, [203,120,132], [0], 1],   //22
  ["bassonsChrom", 52, "group",  800,  540, 16, [203,120,132], [9], 2],  //23
  ["pianoEchelle1", 53,   "tank",  497,  306, 8, [203,120,132], [22,13], 1], //24
  ...
  ["Altos", 76, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Contrebasses", 77, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Trompettes", 78, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Bassons", 79, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Piano", 80, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Trombones", 81, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Flutes", 82, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Fin", 83, "group",  922,  499, 0, [203,120,132], [18,20,14], 1],
  ["Clarinettes", 84, "group",  350,  25, 0, [203,120,132], [], 10],
  ["Hautbois", 85, "group",  350,  25, 0, [203,120,132], [], 10]
],

[  // Techno
  // nom du groupe, index, type, x, y, nbe d'éléments, color, prédécesseurs
  ["evolve",  0, "tank", 10, 30, 20, [103,120,132], [] ],
  ["poly",      1, "tank",    100, 150, 10, [213,120,132], [0] ], 
  ["fm",         2, "group",  200,  200, 13, [203,120,132], [1,0] ],
  ["massive",3, "group",  250,250,  6, [89,99,77], [0,1,2]  ],
  ["round",    4,"group",   300,300, 8, [78,67,67], [3] ],
  ["absynth", 5, "group",  350,350, 6, [87,98,132], [4] ],
  ["drone",    6, "tank",  400,400, 10, [56,120,132], [5] ],
  ["alien",      7, "group",  450, 450, 29, [203,100,102], [6] ],
  ["notes",     8, "group",   500, 100, 8, [100,100,100], [1,2,3,4,5,6,7] ]
],
