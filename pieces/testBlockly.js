...
exports.automate1 = './autoTestBlockly1';
exports.automate2 = './autoTestBlockly2';
exports.automate3 = './autoTestBlockly3';
...
exports.soundFilesPath2 = "opus5";
exports.soundFilesPath3 = "opus5";
...
************************************/
exports.tempoMax =  1000; // En ms
exports.tempoMin = 900; // En ms
...
const groupeOpus5 = [
  ["Piano1Intro1", 10,  "tank",  10,  51, 1, orange, [], 1],
  ...
  ["ViolonsIntro1", 31,  "tank",  400,  51, 2, gris, [], 1],
  ...
  ["NappeViolons", 50, "group",  10,  350, 7, bleu, [], 1],
  ["NappeAlto", 2, "group",  100,  400, 7, bleu, [], 1],
  ["NappeCello", 3,  "group",  200,  350, 7, bleu, [], 1],
  ["NappeCelloRythme", 4,  "group",  300,  400, 7, bleu, [], 1],
  ["NappeCTB", 5,  "group",  400,  350, 7, bleu, [], 1],
  ["NappeCTBRythme", 6,  "group",  500,  400, 7, bleu, [], 1],
  ["S1Action", 7,  "group",  600,  350, 7, bleu, [], 1],
  ["S2Action", 8,  "group",  600,  450, 7, bleu, [], 1], 

  ["Trompette1", 60,  "tank",  700,  51, 3, rouge, [], 1],
  ...
  ["Cors1", 73,  "tank",  100,  450, 4, marron, [], 1],
  ["Cors2", 74,  "tank",  ,  , 4,  grisvert, []],  
  ["Cors3", 75,  "tank",  ,  , 4,  grisvert, []],
  ["Cors4", 76,  "tank",  ,  , 4,  grisvert, []],

  ["FluteDebut1", 87,  "tank",  700,  251, 5, grisvert, [], 1],
  ...
  ["ClarinetteDebut1", 115,  "tank",  10,  550, 6, violet, [], 1],
  ...
  ["BassonDebut1", 130,  "tank",  450,  550, 7, ocre, [], 1],
  ...
  ["Percu1", 150,  "tank",  800,  600, 8, grisvert, [], 1],
  ...
  ["RiseHit",   160,  "group",  100,  350, 7, bleu, [], 10]
];

exports.groupesDesSons = [ groupeOpus5, groupeOpus5, groupeOpus5 ];
