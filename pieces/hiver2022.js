...
// Generated by Skini: Tue Jun 21 2022 16:39:35 GMT+0200 (heure d’été d’Europe centrale)
"use strict"
...
const groupesDesSons = [
  [ "groupe0",0, "group",20,50,20,"#CF1919",[2,3,4,5,6],1 ],
  [ "groupe1",1, "group",20,200,20,"#008CBA",[],1 ],
  [ "groupe2",2, "group",20,350,20,"#4CAF50",[1,2,3],1 ],
  [ "groupe3",3, "group",20,500,20,"#5F6262",[],1 ],
  [ "groupe4",4, "group",20,650,20,"#797bbf",[],1 ],
  ...
  [ "groupe9",9, "group",200,650,20,"#666633",[],1 ],
  [ "groupe10",10, "group",320,340,20,"#039879",[],1 ],
  [ "groupe11",11, "group",320,340,20,"#315A93",[],1 ],
  [ "groupe12",12, "group",320,340,20,"#BCA104",[],1 ],
  [ "groupe13",13, "group",320,340,20,"#E0095F",[],1 ],
  ...
  [ "groupe18",18, "group",350,500,20,"#E0095F",[],1 ],
  ];
