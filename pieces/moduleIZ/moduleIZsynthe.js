...
// Generated by Skini: Wed Apr 12 2023 10:58:12 GMT+0200 (heure d’été d’Europe centrale)
"use strict"
...
const groupesDesSons = [
  [ "zone1",1, "group",370,100,20,"#CF1919",[],1 ],
  [ "zone2",2, "group",370,300,20,"#4CAF50",[],1 ],
  [ "zone3",3, "group",550,100,20,"#5F6262",[],1 ],
  [ "zone4",4, "group",550,300,20,"#797bbf",[],1 ],
  [ "zone6",6, "group",750,300,20,"#797bbf",[],1 ],
  [ "zone7",7, "group",370,400,20,"#CF1919",[],1 ],
  [ "zone8",8, "group",550,400,20,"#4CAF50",[],1 ],
  [ "zone9",9, "group",370,500,20,"#5F6262",[],1 ],
  [ "zone10",10, "group",550,500,20,"#797bbf",[],1 ],
  ];
