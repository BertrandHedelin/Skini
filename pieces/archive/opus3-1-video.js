...
exports.automate1 = './autoOpus3-1-video';
exports.automate2 = '';
exports.automate3 = '';
...
const grisbleu = '#315A93';
  ...
  // Les groupes d'un tank doivent se suivre pour score.
...
const groupeOpus2 = [
  ...
  ["flutesRouge", 85,   "group",  536,  528, 14, grisbleu, [15], 2], //28
  ...
  ["percu", 112,   "group",  608,  326, 19, grisbleu, [15], 2], //34
  ...
  ["hautboisTonal", 130,   "group", 10, 100 , 14, grisbleu, [], 2],

  ["RiseHit1", 131,   "tank",  10,  350, 22, grisbleu, [], 2], //35
  ["RiseHit2", 132,   "tank",  50,  400, 23, grisbleu, [], 2],
  ["RiseHit3", 133,   "tank",  100,  450, 24, grisbleu, [], 2],
  ["RiseHit4", 134,   "tank",  150,  500, 25, grisbleu, [], 2],
  ["RiseHit5", 135,   "tank",  200,  550, 26, grisbleu, [], 2],
  ["RiseHit6", 136,   "tank",  250,  600, 27, grisbleu, [], 2],
  ["RiseHit7", 137,   "tank",  300,  650, 28, grisbleu, [], 2],
  // Exemple de choix. Pour ne pas afficher un choix dans score, il suffit de le mettre dans
  // une scene inactive (ici 20)
  ["Noir", 122, "group",  10,  100, 0, grisbleu, [], 20], //
  ["Rouge", 123, "group",  520,  600, 0, grisbleu, [], 20], //
  ["Bleu", 124, "group",  350,  25, 0, grisbleu, [], 20], //
  ["Jaune", 125, "group",  350,  25, 0, grisbleu, [], 20] //
];
