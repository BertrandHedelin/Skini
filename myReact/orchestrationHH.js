              ...
              hh.EMIT(
                {
                  ...
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop78939 = this["stop78939"];
                      return 0;
                    })());
                  }
                },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop113642" : "stop113642",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop113642 = this["stop113642"];
                      return 0;
                    })());
                  }
                },
      ...
      hh.ABORT(
        ...
        hh.SIGACCESS({
          ...
          hh.RUN({
            "%location":{},
            "%tag":"run",
            "module": hh.getModule(  "TransPianoEtNappe3", {}),
            "tick":"",
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop327492" : "stop327492",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop327492 = this["stop327492"];
                      return 0;
                    })());
                  }
                },
      ...
      hh.ABORT(
        ...
        hh.SIGACCESS({
          ...
          hh.RUN({
            "%location":{},
            "%tag":"run",
            "module": hh.getModule(  "TransPianoEtNappe2", {}),
            "tick":"",
          ...
          hh.EMIT(
            {
              ...
              "%tag":"emit",
              //"stopReservoir":"stopReservoir",
              "stop955542" : "stop955542",
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop955542 = this["stop955542"];
                  return 0;
                })());
              }
            },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop852008" : "stop852008",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop852008 = this["stop852008"];
                      return 0;
                    })());
                  }
                },
          ...
          hh.EMIT(
            {
              ...
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop89435 = this["stop89435"];
                  return 0;
                })());
              }
            },
            ...
            hh.EMIT(
              {
                ...
                "%tag":"emit",
                //"stopReservoir":"stopReservoir",
                "stop314310" : "stop314310",
                "apply":function (){
                  return ((() => {
                    //const stopReservoir = this["stopReservoir"];
                    const stop314310 = this["stop314310"];
                    return 0;
                  })());
                }
              },
