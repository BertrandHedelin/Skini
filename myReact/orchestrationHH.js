...
exports.setSignals = setSignals;
  ...
  ,
    ...
    Basson = hh.MODULE({"id":"Basson","%location":{"filename":"hiphop_blocks.js","pos":1, "block":"makeReservoir"},"%tag":"module"},
        ...
        hh.ATOM(
          {
            ...
            "apply":function () {
              ...
              oscMidiLocal.controlChange(par.busMidiDAW,1,65, Math.round(ratioTranspose * transposeValue + offsetTranspose ));
            }
          }
        ),
  ...
  soloTrompette = hh.MODULE({"id":"soloTrompette","%location":{},"%tag":"module"},
          ...
          hh.ATOM(
            {
              ...
              "%tag":"node",
              "apply":function () {
                DAW.putPatternInQueue('Altenburg');
              }
            }
          ),
          ...
          hh.ATOM(
            {
              ...
              "%tag":"node",
              "apply":function () {
                DAW.putPatternInQueue('Hardenberger');
              }
            }
          ),
          ...
          hh.ATOM(
            {
              ...
              "%tag":"node",
              "apply":function () {
                DAW.putPatternInQueue('Friedrich');
              }
            }
          ),
        ...
        hh.ATOM(
          {
            "%location":{},
            "%tag":"node",
            "apply":function () {console.log('END OF TROMPET SOLO ');}
          }
        ),
            ...
            hh.EMIT(
              {
                "%location":{},
                "%tag":"emit",
                "stop169157" : "stop169157",
                "apply":function (){
                  return ((() => {
                    const stop169157 = this["stop169157"];
                    return 0;
                  })());
                }
              },
      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('--- Reçu Rubinstein');}
        }
      ),
                  ...
                  hh.EMIT(
                    {
                      ...
                      "stop204674" : "stop204674",
                      "apply":function (){
                        return ((() => {
                          //const stopReservoir = this["stopReservoir"];
                          const stop204674 = this["stop204674"];
                          return 0;
                        })());
                      }
                    },
                  ...
                  hh.EMIT(
                    {
                      ...
                      "%tag":"emit",
                      //"stopReservoir":"stopReservoir",
                      "stop457786" : "stop457786",
                      "apply":function (){
                        return ((() => {
                          //const stopReservoir = this["stopReservoir"];
                          const stop457786 = this["stop457786"];
                          return 0;
                        })());
                      }
                    },
                  ...
                  hh.EMIT(
                    ...
                    hh.SIGACCESS({
          		    ...
          		    hh.ATOM(
          		      ...
          		      "%tag":"node",
          		      "apply":function () {
                        gcs.informSelecteurOnMenuChange(255," NappeCello", true);
                      }
          		      }
          		 	  ),
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop969871" : "stop969871",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop969871 = this["stop969871"];
                      return 0;
                    })());
                  }
                },
                  ...
                  hh.EMIT(
                    {
                      ...
                      "%tag":"emit",
                      //"stopReservoir":"stopReservoir",
                      "stop297221" : "stop297221",
                      "apply":function (){
                        return ((() => {
                          //const stopReservoir = this["stopReservoir"];
                          const stop297221 = this["stop297221"];
                          return 0;
                        })());
                      }
                    },
                  ...
                  hh.EMIT(
                    {
                      ...
                      "%tag":"emit",
                      //"stopReservoir":"stopReservoir",
                      "stop322917" : "stop322917",
                      "apply":function (){
                        return ((() => {
                          //const stopReservoir = this["stopReservoir"];
                          const stop322917 = this["stop322917"];
                          return 0;
                        })());
                      }
                    },
