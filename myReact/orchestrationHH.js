var cleanZone1, sensor0, cleanZone2, sensor2, cleanZone3, cleanZone4, tick, zone1, zone2, zone3, zone4, zone7, zone8, zone9, zone10;
        ...
        hh.AWAIT(
          {
            ...
            "apply":function (){
              return ((() => {
                ...
                //console.log("*****", 11, 100,5000, INTERFACEZ_RC.nowval );
        ...
        hh.ABORT(
          {
            ...
            "countapply":function (){ return 120;}
          },
          hh.SIGACCESS({
            "signame":"tick",
            "pre":false,
              ...
              hh.ATOM(
                {
                  ...
                  "%tag":"node",
                  "apply":function () {
                    DAW.putPatternInQueue('Massive2');
                  }
                }
              ),
