      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('Foo 2');}
        }
      ),
      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('Foo 3');}
        }
      ),
      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('Foo 4');}
        }
      ),
      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('2 x foo');}
        }
      ),
        ...
        hh.AWAIT(
          {
            ...
            "countapply":function (){ return bar;}
          },
          hh.SIGACCESS({
            "signame":"foo",
            "pre":false,
      ...
      hh.ATOM(
        {
          "%location":{},
          "%tag":"node",
          "apply":function () {console.log('foo x bar');}
        }
      ),
