  ...
  hh.ATOM(
    {
      "%location":{},
      "%tag":"node",
      "apply":function () {console.log('-- Opus4 Blockly');}
    }
  ),
              ...
              hh.EMIT(
                {
                  ...
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop75369 = this["stop75369"];
                      return 0;
                    })());
                  }
                },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop204430" : "stop204430",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop204430 = this["stop204430"];
                      return 0;
                    })());
                  }
                },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop827437" : "stop827437",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop827437 = this["stop827437"];
                      return 0;
                    })());
                  }
                },
          ...
          hh.EMIT(
            {
              ...
              "%tag":"emit",
              //"stopReservoir":"stopReservoir",
              "stop577904" : "stop577904",
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop577904 = this["stop577904"];
                  return 0;
                })());
              }
            },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop862828" : "stop862828",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop862828 = this["stop862828"];
                      return 0;
                    })());
                  }
                },
          ...
          hh.EMIT(
            {
              ...
              "%tag":"emit",
              //"stopReservoir":"stopReservoir",
              "stop895802" : "stop895802",
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop895802 = this["stop895802"];
                  return 0;
                })());
              }
            },
            ...
            hh.EMIT(
              {
                ...
                "%tag":"emit",
                //"stopReservoir":"stopReservoir",
                "stop154839" : "stop154839",
                "apply":function (){
                  return ((() => {
                    //const stopReservoir = this["stopReservoir"];
                    const stop154839 = this["stop154839"];
                    return 0;
                  })());
                }
              },
