var foo, Groupe1, Groupe2, Groupe3, Groupe4, Groupe5;
    ...
    hh.ATOM(
      {
        ...
        hh.ATOM(
          ...
          "%location":{},
          "%tag":"node",
          "apply":function () { gcs.informSelecteurOnMenuChange(0 , "Groupe1OUT",true); }
          }
     	),
        ...
        hh.ATOM(
          ...
          "%location":{},
          "%tag":"node",
          "apply":function () { gcs.informSelecteurOnMenuChange(1 , "Groupe2OUT",true); }
          }
     	),
        ...
        hh.ATOM(
          ...
          "%location":{},
          "%tag":"node",
          "apply":function () { gcs.informSelecteurOnMenuChange(2 , "Groupe3OUT",true); }
          }
     	),
