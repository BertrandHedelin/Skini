var cleanZone1, sensor0, cleanZone2, sensor1, cleanZone3, sensor2, cleanZone4, sensor5, startSensor0, stopSensor0_1, stopSensor0_2, stopSensor0_3, stopSensor0_4, stopSensor0_5, tick;
    ...
    hh.ABORT(
      ...
      hh.SIGACCESS({
        ...
        "cnt":false
          ...
          // Avec les "suspend" on s'assure de ne pas prendre en compte de
        // signaux des capteurs pendant que le pattern déclenché se joue.
          ...
          hh.LOOP(
            ...
            hh.SUSPEND(
              {
                "%location":{suspend: stopSensor0_1},
                "%tag":"do/every",
                "immediate":false,
                "apply": function (){return ((() => {
                    const stopSensor0_1=this["stopSensor0_1"];
                    return stopSensor0_1.now;
                })());},
                "countapply":function (){ return 1;}
              },
              hh.SIGACCESS({
                "signame":"stopSensor0_1",
                "pre":false,
                "val":false,
                "cnt":false
              }),
                    ...
                    hh.AWAIT(
                      {
                        ...
                        "apply":function (){
                          return ((() => {
                            const INTERFACEZ_RC0 = this["INTERFACEZ_RC0"];
                            //console.log("*****", 0, 3000,4000, INTERFACEZ_RC.nowval );
                            if( INTERFACEZ_RC0.nowval !== undefined ) {
                              return INTERFACEZ_RC0.now && ( INTERFACEZ_RC0.nowval[0] === 0
                                && INTERFACEZ_RC0.nowval[1] >3000
                                && INTERFACEZ_RC0.nowval[1] <4000);
                            }
                          })());
                        },
              ...
              hh.ATOM(
                {
                  "%location":{},
                  "%tag":"node",
                  "apply":function () {console.log('Sensor0-1');}
                }
              ),
                ...
                hh.ATOM(
                  {
                    ...
                    "%tag":"node",
                    "apply":function () {
                      DAW.putPatternInQueue('sensor0-1');
                    }
                  }
                ),
                    ...
                    hh.SUSTAIN(
                      {
                        "%location":{},
                        "%tag":"sustain",
                        "stopSensor0_2":"stopSensor0_2",
                        "apply":function (){
                          return ((() => {
                            //const stopSensor0_2=this["stopSensor0_2"];
                            return 0;
                          })());
                        }
                      },
                      hh.SIGACCESS({
                        "signame":"stopSensor0_2",
                        "pre":true,
                        "val":true,
                        "cnt":false
                      })
                    ...
                    hh.SUSTAIN(
                      {
                        "%location":{},
                        "%tag":"sustain",
                        "stopSensor0_3":"stopSensor0_3",
                        "apply":function (){
                          return ((() => {
                            //const stopSensor0_3=this["stopSensor0_3"];
                            return 0;
                          })());
                        }
                      },
                      hh.SIGACCESS({
                        "signame":"stopSensor0_3",
                        "pre":true,
                        "val":true,
                        "cnt":false
                      })
                    ...
                    hh.SUSTAIN(
                      {
                        "%location":{},
                        "%tag":"sustain",
                        "stopSensor0_4":"stopSensor0_4",
                        "apply":function (){
                          return ((() => {
                            //const stopSensor0_4=this["stopSensor0_4"];
                            return 0;
                          })());
                        }
                      },
                      hh.SIGACCESS({
                        "signame":"stopSensor0_4",
                        "pre":true,
                        "val":true,
                        "cnt":false
                      })
                    ...
                    hh.SUSTAIN(
                      {
                        "%location":{},
                        "%tag":"sustain",
                        "stopSensor0_5":"stopSensor0_5",
                        "apply":function (){
                          return ((() => {
                            //const stopSensor0_5=this["stopSensor0_5"];
                            return 0;
                          })());
                        }
                      },
                      hh.SIGACCESS({
                        "signame":"stopSensor0_5",
                        "pre":true,
                        "val":true,
                        "cnt":false
                      })
          ...
          hh.LOOP(
            ...
            hh.SUSPEND(
              {
                "%location":{suspend: stopSensor0_2},
                "%tag":"do/every",
                "immediate":false,
                "apply": function (){return ((() => {
                    const stopSensor0_2=this["stopSensor0_2"];
                    return stopSensor0_2.now;
                })());},
                "countapply":function (){ return 1;}
              },
              hh.SIGACCESS({
                    ...
                    hh.AWAIT(
                      {
                        ...
                        "apply":function (){
                          return ((() => {
                            const INTERFACEZ_RC0 = this["INTERFACEZ_RC0"];
                            //console.log("*****", 0, 2000,2999, INTERFACEZ_RC.nowval );
                            if( INTERFACEZ_RC0.nowval !== undefined ) {
                              return INTERFACEZ_RC0.now && ( INTERFACEZ_RC0.nowval[0] === 0
                                && INTERFACEZ_RC0.nowval[1] >2000
                                && INTERFACEZ_RC0.nowval[1] <2999);
                            }
                          })());
                        },
                        "countapply":function (){ return 1;}
              ...
              hh.ATOM(
                {
                  "%location":{},
                  "%tag":"node",
                  "apply":function () {console.log('Sensor0-2');}
                }
              ),
                ...
                hh.ATOM(
                  {
                    ...
                    "%tag":"node",
                    "apply":function () {
                      DAW.putPatternInQueue('sensor0-2');
                    }
                  }
                ),
          ...
          hh.LOOP(
            ...
            hh.SUSPEND(
              {
                "%location":{suspend: stopSensor0_3},
                "%tag":"do/every",
                "immediate":false,
                "apply": function (){return ((() => {
                    const stopSensor0_3=this["stopSensor0_3"];
                    return stopSensor0_3.now;
                })());},
                "countapply":function (){ return 1;}
              },
              hh.SIGACCESS({
                    ...
                    hh.AWAIT(
                      {
                        ...
                        "apply":function (){
                          return ((() => {
                            const INTERFACEZ_RC0 = this["INTERFACEZ_RC0"];
                            //console.log("*****", 0, 1000,1999, INTERFACEZ_RC.nowval );
                            if( INTERFACEZ_RC0.nowval !== undefined ) {
                              return INTERFACEZ_RC0.now && ( INTERFACEZ_RC0.nowval[0] === 0
                                && INTERFACEZ_RC0.nowval[1] >1000
                                && INTERFACEZ_RC0.nowval[1] <1999);
                            }
                          })());
                        },
              ...
              hh.ATOM(
                {
                  "%location":{},
                  "%tag":"node",
                  "apply":function () {console.log('Sensor0-3');}
                }
              ),
                ...
                hh.ATOM(
                  {
                    ...
                    "%tag":"node",
                    "apply":function () {
                      DAW.putPatternInQueue('sensor0-3');
                    }
                  }
                ),
          ...
          hh.LOOP(
            ...
            hh.SUSPEND(
              {
                "%location":{suspend: stopSensor0_4},
                "%tag":"do/every",
                "immediate":false,
                "apply": function (){return ((() => {
                    const stopSensor0_4=this["stopSensor0_4"];
                    return stopSensor0_4.now;
                })());},
                "countapply":function (){ return 1;}
              },
              hh.SIGACCESS({
                    ...
                    hh.AWAIT(
                      {
                        ...
                        "apply":function (){
                          return ((() => {
                            const INTERFACEZ_RC0 = this["INTERFACEZ_RC0"];
                            //console.log("*****", 0, 500,999, INTERFACEZ_RC.nowval );
                            if( INTERFACEZ_RC0.nowval !== undefined ) {
                              return INTERFACEZ_RC0.now && ( INTERFACEZ_RC0.nowval[0] === 0
                                && INTERFACEZ_RC0.nowval[1] >500
                                && INTERFACEZ_RC0.nowval[1] <999);
                            }
                          })());
                        },
                        "countapply":function (){ return 2;}
              ...
              hh.ATOM(
                {
                  "%location":{},
                  "%tag":"node",
                  "apply":function () {console.log('Sensor0-4');}
                }
              ),
                ...
                hh.ATOM(
                  {
                    ...
                    "%tag":"node",
                    "apply":function () {
                      DAW.putPatternInQueue('sensor0-4');
                    }
                  }
                ),
          ...
          hh.LOOP(
            ...
            hh.SUSPEND(
              {
                "%location":{suspend: stopSensor0_5},
                "%tag":"do/every",
                "immediate":false,
                "apply": function (){return ((() => {
                    const stopSensor0_5=this["stopSensor0_5"];
                    return stopSensor0_5.now;
                })());},
                "countapply":function (){ return 1;}
              },
              hh.SIGACCESS({
                    ...
                    hh.AWAIT(
                      {
                        ...
                        "apply":function (){
                          return ((() => {
                            const INTERFACEZ_RC0 = this["INTERFACEZ_RC0"];
                            //console.log("*****", 0, 0,499, INTERFACEZ_RC.nowval );
                            if( INTERFACEZ_RC0.nowval !== undefined ) {
                              return INTERFACEZ_RC0.now && ( INTERFACEZ_RC0.nowval[0] === 0
                                && INTERFACEZ_RC0.nowval[1] >0
                                && INTERFACEZ_RC0.nowval[1] <499);
                            }
                          })());
                        },
                        "countapply":function (){ return 2;}
              ...
              hh.ATOM(
                {
                  "%location":{},
                  "%tag":"node",
                  "apply":function () {console.log('Sensor0-5');}
                }
              ),
                ...
                hh.ATOM(
                  {
                    ...
                    "%tag":"node",
                    "apply":function () {
                      DAW.putPatternInQueue('sensor0-5');
                    }
                  }
                ),
