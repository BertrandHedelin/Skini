    ...
    hh.TRAP(
    {
      ...
      hh.ABORT({
        ...
        hh.ATOM(
            ...
            "%tag":"node",
            "apply":function () {
                console.log("-- MAKE RESERVOIR:", "SaxIntro1" );
                var msg = {
                  type: 'startTank',
                  value:  "SaxIntro1"
                }
    ...
    hh.TRAP(
    {
      ...
      hh.ABORT({
        ...
        hh.ATOM(
            ...
            "%tag":"node",
            "apply":function () {
                console.log("-- MAKE RESERVOIR:", "BrassIntro1" );
                var msg = {
                  type: 'startTank',
                  value:  "BrassIntro1"
                }
    ...
    hh.TRAP(
    {
      ...
      hh.ABORT({
        ...
        hh.ATOM(
            ...
            "%tag":"node",
            "apply":function () {
                console.log("-- MAKE RESERVOIR:", "FluteIntro1" );
                var msg = {
                  type: 'startTank',
                  value:  "FluteIntro1"
                }
              ...
              hh.EMIT(
                {
                  ...
                  "stop657075" : "stop657075",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop657075 = this["stop657075"];
                      return 0;
                    })());
                  }
                },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop335434" : "stop335434",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop335434 = this["stop335434"];
                      return 0;
                    })());
                  }
                },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop539336" : "stop539336",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop539336 = this["stop539336"];
                      return 0;
                    })());
                  }
                },
          ...
          hh.EMIT(
            {
              ...
              "%tag":"emit",
              //"stopReservoir":"stopReservoir",
              "stop858518" : "stop858518",
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop858518 = this["stop858518"];
                  return 0;
                })());
              }
            },
              ...
              hh.EMIT(
                {
                  ...
                  "%tag":"emit",
                  //"stopReservoir":"stopReservoir",
                  "stop356412" : "stop356412",
                  "apply":function (){
                    return ((() => {
                      //const stopReservoir = this["stopReservoir"];
                      const stop356412 = this["stop356412"];
                      return 0;
                    })());
                  }
                },
          ...
          hh.EMIT(
            {
              ...
              "%tag":"emit",
              //"stopReservoir":"stopReservoir",
              "stop234373" : "stop234373",
              "apply":function (){
                return ((() => {
                  //const stopReservoir = this["stopReservoir"];
                  const stop234373 = this["stop234373"];
                  return 0;
                })());
              }
            },
            ...
            hh.EMIT(
              {
                ...
                "%tag":"emit",
                //"stopReservoir":"stopReservoir",
                "stop865077" : "stop865077",
                "apply":function (){
                  return ((() => {
                    //const stopReservoir = this["stopReservoir"];
                    const stop865077 = this["stop865077"];
                    return 0;
                  })());
                }
              },
