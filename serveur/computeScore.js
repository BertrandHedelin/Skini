/*************************************************************************
  ...
  © Copyright 2021, B. Petit-Hédelin

	EVALUATION ET NOTATION DES SEQUENCES DE PATTERNS

 	Pattern : Note,	Note stop, Flag usage,	Texte, Fichier son,
 	Instrument [5],	Slot, Type [7], Pas utilisé, Groupe,	Durée
...
=====================================================================================*/
// Ajoute un client dans la liste des clients connectés s'il n'existe pas déjà
